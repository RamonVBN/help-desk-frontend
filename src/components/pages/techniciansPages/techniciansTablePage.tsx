...
export function TechniciansTablePage({
  initialTechniciansData,
}: TechniciansTablePageProps) {
      ...
      <div className="flex justify-between">
        ...
        <Link href={"technicians/new"}>
          <Button className="rounded-[5px] lg:px-4">
            ...
            <span className="text-[14px] leading-[140%] font-normal text-gray-600 hidden lg:block">
              Novo
            </span>
          </Button>
        </Link>
              ...
              return (
                <TableRow key={technician.id}>
                  <TableCell>
                    <span className="flex gap-3 items-center">
                      <Avatar
                        ...
                        className="w-7 h-7 text-[12.25px] leading-[140%] tracking-[10%]"
                      />
                      <span className="font-bold text-[14px] leading-[140%] text-gray-200">
                        {technician.name}
                      </span>
                    </span>
                  </TableCell>
                  ...
                  <TableCell className="hidden md:table-cell">
                    <span className="text-[14px] leading-[120%] text-gray-200">
                      {technician.email}
                    </span>
                  </TableCell>

                  <TableCell className="max-w-10">
                    <TableCellHoursAvailable
                      className="md:hidden"
                      limit={1}
                      hoursList={technician.technician.availableHours}
                    />
                    <TableCellHoursAvailable
