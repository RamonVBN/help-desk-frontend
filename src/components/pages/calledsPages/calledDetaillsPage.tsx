...
export function CalledDetailsPage() {
              ...
              <Card.Root className="p-5 lg:p-6 flex gap-5 lg:flex-[30rem]">
                <div>
                  <div className="flex justify-between items-center">
                    <span className="font-bold text-xs leading-[140%] text-gray-300">
                      {called?.id}
                    </span>
                ...
                {user?.role !== "CLIENT" && (
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      <Avatar
                        imageUrl={called.client.imageUrl}
                        username={called.client.name}
                        className="w-5 h-5 text-[8.75px]"
                      />
                      <span className="text-[0.875rem] leading-[140%] text-gray-200">
                        {called?.client.name}
                      </span>
                ...
                <div className="flex flex-col gap-8">
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-2">
                      <Avatar
                        imageUrl={called.technician.imageUrl}
                        username={called.technician.name}
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs leading-[140%] text-gray-300">
                          {called.technician.email}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-xs leading-[140%] text-gray-200">
                          {formatPrice(called.service.price)}
                        </span>
                      </div>
                      ...
                      {user?.role === "TECHNICIAN" && (
                        <div className="flex justify-between">
                          ...
                          <span className="text-xs leading-[140%] text-gray-200">
                            {formatPrice(
                              called.additionalServices.reduce(
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex justify-between items-center">
                      ...
                      >
                        ...
                        <ServiceModal
                          handleCloseModal={handleCloseAddServiceModal}
                      ...
                      {called.additionalServices.map((addService) => {
                        return (
                          <div key={addService.id}>
                            <div className="flex justify-between items-center">
                              <span className="text-xs font-bold leading-[140%] text-gray-200">
                                {addService.description}
                              </span>

                              <div className="flex gap-6 items-center">
                                <span className="text-xs leading-[140%] text-gray-200">
                                  {formatPrice(addService.price)}
                                </span>
