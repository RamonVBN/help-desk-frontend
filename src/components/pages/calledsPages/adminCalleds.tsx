...
export function AdminCalleds({ initialCalledsData }: AdminCalledsProps) {
  const { data: adminCalleds = initialCalledsData } = useQuery<Called[]>({
    queryKey: ["calleds"],
    queryFn: getCalleds,
  })
                ...
                <TableRow key={called.id}>
                  ...
                  <TableCell>
                    <span className="flex flex-col">
                      <span
                        className="text-[0.875rem] leading-[140%] text-gray-200 font-bold 
