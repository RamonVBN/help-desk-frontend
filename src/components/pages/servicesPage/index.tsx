...
export function ServicesPageTable({
  initialServicesData,
}: ServicesPageTableProps) {
  const [isRegisterModalOpen, setIsRegisterModalOpen] = useState(false)
  const [serviceModalTableOpenId, setModalTableOpenId] = useState<
    string | null
  >(null)
    ...
    <div className="flex flex-col gap-4 md:gap-6 w-full">
      <div className="flex justify-between">
        ...
        >
          ...
          <ServiceModal
            handleCloseModal={handleCloseRegisterServiceModal}
                ...
                <TableRow key={service.id}>
                  ...
                  <TableCell className="text-right lg:w-[470px]">
                    <div className="flex gap-2 justify-end items-center">
                      ...
                      <Dialog
                        open={serviceModalTableOpenId === service.id}
                        onOpenChange={() => {
                      ...
                      >
                        ...
                        <ServiceModal
                          handleCloseModal={handleCloseServiceTableModal}
                          title="Serviço"
                          serviceId={service.id}
                        />
                      </Dialog>
